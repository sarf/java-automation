 ...
 * time. This is mainly done to make it possible for certain classes to notify the developer that a different behaviour
 * from a regular Predicate is expected.
 * <p>
 ...
 * independent of the value under test (the timeout mentioned earlier), others may be depedent on the state of the
 * object (and not just in the regular test:ing way).
 */
