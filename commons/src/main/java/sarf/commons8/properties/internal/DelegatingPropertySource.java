...
/**
 * Allows for delegating to a particular property source. While it is essentially the same as a {@link
 * ChainedPropertySource} with just 1 property source, this version is both cheaper and faster, but also allows for a
 * few neat extensions.
 */
