...
import sarf.commons8.util.OptionalUtil;

import java.util.*;
import java.util.function.Function;

import static sarf.commons8.util.CollectionUtil.addAll;
import static sarf.commons8.util.CollectionUtil.union;
 ...
 * <p>
 * This can be somewhat counterintuitive for people who are used to having the most important being the last in the
 * list.
 */
@Data
