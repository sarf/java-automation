...
/**
 * More flexible read-only version of Properties. Use {@link sarf.commons12.properties.internal.PropertySourceFactory} in order
 * to get hold of interesting {@link PropertySource}:s.
 * <p>
 * One of the major flaws of this class is that the null value is treated like Optional.empty() in a not super-consistent manner.
 *
